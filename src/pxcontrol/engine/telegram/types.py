...
def audience_many(kind: CommunityKind) -> str:
	"""Аудитория сообщества без числа: «подписчиков» у канала, «участников» у группы.

	Родительный падеж множественного числа — для фраз «число участников»,
	«в списке подписчиков». Одно место на движок и интерфейс: итоги задач
	пишет движок, а подписи формы — интерфейс, и говорить им надо одинаково.
	"""
	return "участников" if kind is CommunityKind.GROUP else "подписчиков"
