...
| `PostDraft` | `posts.py` | черновик публикации — единый вход для всех типов контента; `markup` — клавиатура под постом (ADR-0031), её наличие влияет на выбор маршрута отправки; `markup_first` — режим «кнопки важнее» у отложенного поста |
