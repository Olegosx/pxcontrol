...
| [0040](0040-join-requests-task.md) | Задача «Приём заявок»: одобрение заявок на вступление с правилами | accepted (одобрение с ограничением ждёт настоящей заявки) |
