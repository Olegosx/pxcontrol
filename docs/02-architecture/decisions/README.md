...
> Статус: 🟢 готов · Обновлено: 2026-09-16 · Владелец: olegosx
...
| [0028](0028-scheduled-posts-as-queue.md) | Отложенные записи как очередь: правка на сервере и общий список карточек | accepted |
...
| [0032](0032-publishing-section-post-stages.md) | Раздел «Публикация»: подпункты по стадиям жизни поста | proposed |
