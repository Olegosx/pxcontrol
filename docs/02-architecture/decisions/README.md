...
> Статус: 🟢 готов · Обновлено: 2026-09-20 · Владелец: olegosx
...
| [0026](0026-community-maintenance.md) | Обслуживание сообществ: чистка служебных записей | accepted |
| [0027](0027-community-statistics.md) | Статистика сообщества: источники, темпы опроса, локальная история | accepted |
| [0028](0028-scheduled-posts-as-queue.md) | Отложенные записи как очередь: правка на сервере и общий список карточек | accepted — место в навигации замещено (→0032) |
| [0029](0029-users-and-bots-section.md) | Раздел «Пользователи и боты»: сущность первого уровня и приостановка | accepted |
| [0030](0030-account-activity.md) | Учёт активности пользователей и ботов: боты на дорожках, запись на операцию | accepted |
...
| [0038](0038-community-tasks.md) | Задачи сообщества: виды, запуск по требованию и по расписанию, журнал запусков | accepted |
| [0039](0039-reactions-task.md) | Задача «Реакции»: выбранные пользователи ставят реакции записям | accepted |
| [0040](0040-join-requests-task.md) | Задача «Приём заявок»: одобрение заявок на вступление с правилами | accepted |
| [0041](0041-navigation-fixed-tree.md) | Навигация: неизменное дерево, сущности — вне её | accepted |
| [0042](0042-caption-presets.md) | Пресеты подписи: название — поле, разбор имени файла — у поля | accepted |
| [0043](0043-community-settings-in-telegram.md) | Настройки сообщества в Telegram: каталог, транспорты по ключам, экран по каталогу | accepted |
| [0044](0044-bitrate-on-rescale.md) | Битрейт при смене разрешения: постоянное качество или пересчёт по площади | accepted |
