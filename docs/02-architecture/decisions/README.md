...
| [0039](0039-reactions-task.md) | Задача «Реакции»: выбранные пользователи ставят реакции записям | accepted (проба живьём — впереди) |
| [0040](0040-join-requests-task.md) | Задача «Приём заявок»: одобрение заявок на вступление с правилами | accepted (проба живьём — впереди) |
